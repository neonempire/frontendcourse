...
<body>
    <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand mr-auto" href="#"><a class="navbar-brand mr-auto" href="#"><img src="./img/logo.png"
                        height="30" width="41"></a></a>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Reservation card</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group row">
                            <label for="nuguests" class="col-12  col-form-label">Number of guests</label>
                            <div class="col-12  col-sm-12">
                                ...
                                <div class="form-check form-check-inline" data-toggle="buttons">
                                    ...
                                    <label class="form-check-label active" for="inlineRadio2">2</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                ...
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-success active">
                                        <input type="radio" name="options" id="option1" autocomplete="on" checked
                                            data-toggle="buttons" aria-pressed="true"> Non-Smoking
                                    </label>
                        ...
                        <div class="form-row">
                            <label for="dateTime" class="col-12 col-form-label">Date and Time</label>
        ...
        <div class="container">
            <div class="row row-header">
                ...
                <div class="col-12 col-sm-4 align-self-center">
                    ...
                    <button type="button" class="btn btn-block nav-link btn-warning" id="reserveButton">
                        Reserve Table
                    </button>
                </div>
            </div>
                ...
                <div id="mycarousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="./img/buffet.png" alt="Buffe">
                            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="row row-content align-items-center">
            ...
            <div class="col col-sm  order-sm-last col-md">
                <div class="media">
                    ...
                    <img class="d-flex mr-3 img-thumbnail align-self-center" src="./img/buffet.png" alt="Buffe">
                </div>
            </div>
        </div>
        <div class="row row-content">
